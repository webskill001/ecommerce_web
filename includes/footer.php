        ...
        <div class="row">
            <div class="col col-md-3">
                ...
                <ul style="list-style:none;text-transform:Capitalize;">
                    <h5>pages</h5>
                    <li><a href="cart.php" class="text-dark text-muted" style="text-transform:Capitalize;">shopping cart</a></li>
                    ...
                    <li><a href="customer/myaccount.php" class="text-dark text-muted" style="text-transform:Capitalize;">my account</a></li>
                </ul>
                <ul style="list-style:none;text-transform:Capitalize;">
                    <h5>user section</h5>
                    <?php
            ...
            <div class="col col-md-3">
                <ul style="list-style:none;text-transform:Capitalize;">
                    ...
                    <li class="text-dark" style="text-transform:Capitalize;"><a href="<?php echo WEBSITE_PATH; ?>" class="text-dark text-muted"><strong>localhost.com</strong></a></li>
